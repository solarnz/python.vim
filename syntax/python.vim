...
" Enable python_light syntax for python files
call python_light#default('g:python_light', 1)
call python_light#default('g:python_light_syntax', g:python_light)

" DESC: Disable script loading
if !g:python_light || !g:python_light_syntax || python_light#default('b:current_syntax', 'python_light')
    finish
endif
...
call python_light#default('g:python_light_syntax_all', 1)

" Highlight 'print' as function
call python_light#default("g:python_light_syntax_print_as_function", 0)

" Highlight '=' operator
call python_light#default('g:python_light_syntax_highlight_equal_operator', g:python_light_syntax_all)

" Highlight '*' operator
call python_light#default('g:python_light_syntax_highlight_stars_operator', g:python_light_syntax_all)

" Highlight 'self' keyword
call python_light#default('g:python_light_syntax_highlight_self', g:python_light_syntax_all)

" Highlight indent's errors
call python_light#default('g:python_light_syntax_indent_errors', g:python_light_syntax_all)

" Highlight space's errors
call python_light#default('g:python_light_syntax_space_errors', g:python_light_syntax_all)

" Highlight string formatting
call python_light#default('g:python_light_syntax_string_formatting', g:python_light_syntax_all)
call python_light#default('g:python_light_syntax_string_format', g:python_light_syntax_all)
call python_light#default('g:python_light_syntax_string_templates', g:python_light_syntax_all)
call python_light#default('g:python_light_syntax_doctests', g:python_light_syntax_all)

" Support docstrings in syntax highlighting
call python_light#default('g:python_light_syntax_docstrings', 1)

" Highlight builtin objects (True, False, ...)
call python_light#default('g:python_light_syntax_builtin_objs', g:python_light_syntax_all)

" Highlight builtin types (str, list, ...)
call python_light#default('g:python_light_syntax_builtin_types', g:python_light_syntax_all)

" Highlight builtin types (div, eval, ...)
call python_light#default('g:python_light_syntax_builtin_funcs', g:python_light_syntax_all)

" Highlight exceptions (TypeError, ValueError, ...)
call python_light#default('g:python_light_syntax_highlight_exceptions', g:python_light_syntax_all)

" More slow synchronizing. Disable on the slow machine, but code in docstrings
" could be broken.
call python_light#default('g:python_light_syntax_slow_sync', 1)
...
" ============
    ...
    if !g:python_light_syntax_print_as_function
        syn keyword pythonStatement print
    endif

    if g:python_light_syntax_highlight_equal_operator
        syn match pythonExtraOperator "\%(=\)"
    endif

    if g:python_light_syntax_highlight_stars_operator
        syn match pythonExtraOperator "\%(\*\|\*\*\)"
    endif
    
    if g:python_light_syntax_highlight_self
...
" ==========
    ...
    if g:python_light_syntax_indent_errors
        syn match pythonIndentError "^\s*\( \t\|\t \)\s*\S"me=e-1 display
    endif

    " Trailing space errors
    if g:python_light_syntax_space_errors
...
" ===========
    ...
    " String formatting
    if g:python_light_syntax_string_formatting
        syn match pythonStrFormatting   "%\(([^)]\+)\)\=[-#0 +]*\d*\(\.\d\+\)\=[hlL]\=[diouxXeEfFgGcrs%]" contained containedin=pythonString,pythonUniString,pythonRawString,pythonUniRawString
        syn match pythonStrFormatting   "%[-#0 +]*\(\*\|\d\+\)\=\(\.\(\*\|\d\+\)\)\=[hlL]\=[diouxXeEfFgGcrs%]" contained containedin=pythonString,pythonUniString,pythonRawString,pythonUniRawString
    endif

    " Str.format syntax
    if g:python_light_syntax_string_format
    ...
    " String templates
    if g:python_light_syntax_string_templates
    ...
    " DocTests
    if g:python_light_syntax_doctests
        syn region pythonDocTest    start="^\s*>>>" end=+'''+he=s-1 end="^\s*$" contained
        syn region pythonDocTest2   start="^\s*>>>" end=+"""+he=s-1 end="^\s*$" contained
    endif

    " DocStrings
    if g:python_light_syntax_docstrings
...
" ============
    ...
    if g:python_light_syntax_builtin_objs
        syn keyword pythonBuiltinObj True False Ellipsis None NotImplemented
        syn keyword pythonBuiltinObj __debug__ __doc__ __file__ __name__ __package__
    endif
    
    if g:python_light_syntax_builtin_types    
    ...
    " Builtin functions
    if g:python_light_syntax_builtin_funcs
    ...
    if g:python_light_syntax_highlight_exceptions
...
if g:python_light_syntax_slow_sync
